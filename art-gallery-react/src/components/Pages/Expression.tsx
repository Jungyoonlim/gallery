...
import { expressionArtworks } from '../../data/artworks';
...
const Expression: React.FC = () => {
    ...
    const handleNext = () => {
        ...
        setSelectedIndex((prevIndex) => 
            prevIndex !== null ? (prevIndex + 1) % expressionArtworks.length : null
        );
    };
    ...
    const handlePrev = () => {
        setDirection(-1);
        setSelectedIndex((prevIndex) => 
            prevIndex !== null ? (prevIndex - 1 + expressionArtworks.length) % expressionArtworks.length : null
        );
    };
    ...
    return (
        <GalleryContainer>
            <GridContainer layout>
                {expressionArtworks.map((artwork, index) => (
                    <CustomMotionDiv
                        key={artwork.id}
                ...
                {selectedIndex !== null && (
                    ...
                    >
                        ...
                        <AnimatePresence initial={false} custom={direction} mode="wait">
                            ...
                            >
                                <ArtworkCard artwork={expressionArtworks[selectedIndex]} />
                            </ImageWrapper>
                        </AnimatePresence>
                        ...
                        <GalleryNav 
                            totalImages={expressionArtworks.length} 
